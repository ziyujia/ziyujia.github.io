...
description: An Associate Professor at Institute of Automation, Chinese Academy of Sciences (CASIA)
---

# Biography

Dr. Ziyu Jia is an Associate Professor at the Institute of Automation, Chinese Academy of Sciences. **<font color='#1677D2'>He has long been engaged in research on non-invasive brain-computer interfaces and brain disease detection</font>**. His recent work **<font color='#1677D2'>has been published in leading computer science conferences such as ICML, NeurIPS, and KDD, as well as IEEE Transactions journals, with more than 80 papers in total</font>**. Over the past five years, his work has received more than 2900 citations on Google Scholar (H-index 30). He **<font color='#1677D2'>has led more than ten projects including the National Natural Science Foundation of China and National Key R&D Program projects</font>**, and has been granted 6 national invention patents and software copyrights. He serves as a council member of the Beijing Society of Brain Network and Brain-like Intelligence, **<font color='#1677D2'>an Associate Editor or Editorial Board Member for multiple Q1 Top journals including IEEE TAFFC and Information Fusion</font>**, and **<font color='#1677D2'>an Area Chair for conferences such as NeurIPS and IJCNN</font>**. He has been selected for the **<font color='#1677D2'>2025 MSRA StarTrack Program</font>**, the **<font color='#1677D2'>world's top 2% scientists list</font>**, and the **<font color='#1677D2'>CIE Young Talent Program</font>**. His work has made a positive and sustained academic impact in the interdisciplinary area of brain-computer interfaces and artificial intelligence.

<font color='red'>If you are interested in collaborating on topics such as Brain Foundation Models, Multimodal BCI, NeuroAI, and other related topics, I warmly welcome potential collaborators and research interns—feel free to reach out!</font>
...
- **Cross-Modal Knowledge Distillation for Enhanced Unimodal Emotion Recognition**
  ...
  **Ziyu Jia**, Yucheng Liu, Haichao Wang, Tianzi Jiang
  <br>
  IEEE Transactions on Affective Computing (**<font color='#1677D2'>IEEE TAFFC</font>**), 2025
  [[PDF]](https://www.ijcai.org/proceedings/2025/0472.pdf){:target="_blank"}
  <div style="height:1em" />
...
- **ECHO: Toward Contextual Seq2Seq Paradigms in Large EEG Models**
  ...
  <br>
  The Fourteenth International Conference on Learning Representations (**<font color='#1677D2'>ICLR</font>**), 2026
  [[OpenReview]](https://openreview.net/forum?id=ClLQ6cLkoR){:target="_blank"}
  <div style="height:1em" />
...
- **CodeBrain: Bridging Decoupled Tokenizer and Multi-Scale Architecture for EEG Foundation Model**
  ...
  <br>
  The Fourteenth International Conference on Learning Representations (**<font color='#1677D2'>ICLR</font>**), 2026
  [[OpenReview]](https://openreview.net/forum?id=msJgEkjwh5){:target="_blank"}
  <div style="height:1em" />
...
- **Brain foundation models: A survey on advancements in neural signal processing and brain discovery**
  ...
  <br>
  IEEE Signal Processing Magazine (**<font color='#1677D2'>SPM</font>**), 2025
...
- **A Multimodal BiMamba Network with Test-Time Adaptation for Emotion Recognition Based on Physiological Signals**
  ...
  **Ziyu Jia**, Tingyu Du, Zhengyu Tian, Hongkai Li, Yong Zhang, Chenyu Liu
  <br>
  The Thirty-ninth Annual Conference on Neural Information Processing Systems (**<font color='#1677D2'>NeurIPS</font>**), 2025
  [[PDF]](https://openreview.net/pdf/5231d84a71d695555dfa62a15e104cf138dd05f4.pdf){:target="_blank"}
  <div style="height:1em" />
...
- **REFED: A Subject Real-time Dynamic Labeled EEG-fNIRS Synchronized Recorded Emotion Dataset**
  ...
  <br>
  The Thirty-ninth Annual Conference on Neural Information Processing Systems Datasets and Benchmarks Track (**<font color='#1677D2'>NeurIPS</font>**), 2025
  [[PDF]](https://openreview.net/pdf?id=C4IqLzavel){:target="_blank"}
  <div style="height:1em" />

- **Two-stream Dynamic Heterogeneous Graph Recurrent Neural Network for Multi-label Multi-modal Emotion Recognition**
  <br>
  Jing Wang, Zhiyang Feng, Xiaojun Ning, Youfang Lin, Badong Chen, **Ziyu Jia**
  <br>
  IEEE Transactions on Affective Computing (**<font color='#1677D2'>IEEE TAFFC</font>**), 2025
  [[PDF]](https://ieeexplore.ieee.org/document/10966018){:target="_blank"}
  <div style="height:1em" />
...
- **DISD-Net: A dynamic interactive network with self-distillation for cross-subject multi-modal emotion recognition**
  ...
  [[PDF]](https://ieeexplore.ieee.org/document/10857425){:target="_blank"}
  <div style="height:1em" />
...
- **Distillsleepnet: Heterogeneous multi-level knowledge distillation via teacher assistant for sleep staging**
  ...
  **Ziyu Jia**, Heng Liang, Yucheng Liu, Haichao Wang, Tianzi Jiang
  ...
  [[PDF]](https://ieeexplore.ieee.org/document/10663937){:target="_blank"}
  <div style="height:1em" />
...
- **Mutual Distillation Extracting Spatial-temporal Knowledge for Lightweight Multi-channel Sleep Stage Classification**
  ...
  **Ziyu Jia**, Haichao Wang, Yucheng Liu, Tianzi Jiang
  <br>
  Proceedings of the 30th ACM SIGKDD Conference on Knowledge Discovery and Data Mining (**<font color='#1677D2'>KDD</font>**), 2024
  [[PDF]](https://dl.acm.org/doi/10.1145/3637528.3671981){:target="_blank"}
  <div style="height:1em" />
...
- **Subject-adaptation salient wave detection network for multimodal sleep stage classification**
  ...
  <br>
  IEEE Journal of Biomedical and Health Informatics (**<font color='#1677D2'>JBHI</font>**), 2024
  [[PDF]](https://ieeexplore.ieee.org/document/10787148){:target="_blank"}
  <div style="height:1em" />
...
- **Teacher Assistant-Based Knowledge Distillation Extracting Multi-level Features on Single Channel Sleep EEG**
  ...
  [[PDF]](https://www.ijcai.org/proceedings/2023/0439.pdf){:target="_blank"}
...
- **EmotionKD: A Cross-Modal Knowledge Distillation Framework for Emotion Recognition Based on Physiological Signals**
  ...
  [[PDF]](https://dl.acm.org/doi/10.1145/3581783.3612277){:target="_blank"}
  <div style="height:1em" />
...
- **Multi-modal physiological signals based squeeze-and-excitation network with domain adversarial learning for sleep staging**
  ...
  **Ziyu Jia**, Xiyang Cai, Zehui Jiao
  ...
  [[PDF]](https://ieeexplore.ieee.org/document/9668945){:target="_blank"}
  <div style="height:1em" />  
...
- **SleepPrintNet: A Multivariate Multimodal Neural Network based on Physiological Time-series for Automatic Sleep Staging**
  ...
  **Ziyu Jia**, Xiyang Cai, Gaoxing Zheng, Jing Wang, Youfang Lin
  ...
  [[PDF]](https://ieeexplore.ieee.org/document/9357954){:target="_blank"}
  <div style="height:1em" />  
...
- **Airport Flight Delay Causality Mining Method Based on Transfer Entropy.**
  ...
  **Ziyu Jia**, Jing Wang, Youfang Lin, Chao Zhang.
  <br>
  Chinese Patent. Number: CN109558436A
