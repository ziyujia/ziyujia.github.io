...
- **Teacher Assistant-Based Knowledge Distillation Extracting Multi-level Features on Single Channel Sleep EEG**
  ...
  <br>
  Proc. of the 32th International Joint Conference on Artificial Intelligence, 2023 (**<font color='#1677D2'>IJCAI, CCF A, <i>Oral</i></font>**)
...
- **SalientSleepNet: Multimodal Salient Wave Detection Network for Sleep Staging**
  ...
  **Ziyu Jia**, Youfang Lin, Jing Wang, Xuehui Wang, Peiyi Xie, Yingbin Zhang
  <br>
  Proc. of the 30th International Joint Conference on Artificial Intelligence, 2021 (**<font color='#1677D2'>IJCAI, CCF A, <i>Oral</i>, IJCAI Student Grant</font>**), **Acceptance Ratio: 13.9%**
...
- **GraphSleepNet: Adaptive Spatial-Temporal Graph Convolutional Networks for Sleep Stage Classification**
  ...
  **Ziyu Jia**, Youfang Lin, Jing Wang, Ronghao Zhou, Xiaojun Ning, Yuanlai He, Yaoshuai Zhao
  <br>
  Proc. of the 29th International Joint Conference on Artificial Intelligence, 2020, 1324-1330 (**<font color='#1677D2'>IJCAI, CCF A, <i>Oral</i></font>**), **Acceptance Ratio: 12.6%**
...
<p style="margin: 0 0 0.5em 0">和许多人一样，我也经常需要处理大量邮件。为了更高效地沟通常见事项，下面列出一些简单说明：</p>
  <table style="font-size: 0.9em">
  <tr>
  <td> <strong>代码和数据</strong> </td>
      <td> 我非常愿意为学术社区贡献与已有工作相关的代码和数据。通常情况下，相关资源会陆续开源在我的 <a href='https://github.com/ziyujia' target='_blank'>Github</a> 上，但整理和发布可能需要一定时间。 </td>
  </tr>
  <tr>
  <td> <strong>科研合作</strong> </td>
  <td> 我很愿意与研究背景和兴趣相近的同学、老师和研究者开展合作。如果你希望就科研项目进行交流或合作，请在邮件中附上个人简历（CV），并简要说明你的研究兴趣和合作想法。 </td>
  </tr>
  <tr>
  <td> <strong>审稿邀请</strong> </td>
  <td> 我收到的审稿邀请通常多于可实际承担的数量。一般来说，我会优先考虑与本人研究方向高度相关，并且符合学术共同体价值的期刊和会议审稿邀请。 </td>
  </tr>
  </table>
